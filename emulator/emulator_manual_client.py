...
def run(rom: str = ".cache/pokeagent/rom/rom.gba", mp4_path: str = ".cache/pokeagent/out/output.mp4", port: int = 8000, manual_mode: bool = False, fps: int = None, keys_json_path_local: str = ".cache/pokeagent/out/keys.json", save_s3: str = None, save_state: str = None, max_steps: int = 3000, agent_fps: int = 2, connection = None):
...
def main():
    ...
    parser.add_argument("--mp4-path", type=str, default="./.cache/output.mp4", help="Path to mp4 output")
