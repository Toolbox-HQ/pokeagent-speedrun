...
class Trainer:
    ...
    def _inner_training_loop(
        ...
        if use_accelerator_prepare:
            ...
            if hasattr(self.lr_scheduler, "step"):
                ...
                # This is where the model is cast to dytypes and loaded onto device
        ...
        for epoch in range(epochs_trained, num_train_epochs):
            ...
            for _ in range(total_updates):
                ...
                for i, inputs in enumerate(batch_samples):
                    ...
                    with context():
                        tr_loss_step, outputs = self.training_step(
    ...
    def training_step(
        ...
        # GA could cause issues due to some tokens being masked and vision labels being created in fwd pass
        if (
    ...
    @staticmethod
    def reduce_metrics(outputs: List):
        
        metrics = {}
        keys = set()

        [keys.update(output.keys()) for output in outputs]
    ...
    def evaluation_loop(
        ...
        for _, inputs in enumerate(dataloader):
            ...
            outputs.append(Trainer.detach_dict(logits))
